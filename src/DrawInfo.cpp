...
// default constructor
DrawInfo::DrawInfo() : DataEntry("drawinfo", "<dlist><decorative><angvel><extents><sphere><corner><vertex><normal><texcoord><lod>") {
...
DrawInfo::DrawInfo(string& data) : DataEntry("drawinfo", "<dlist><decorative><angvel><extents><sphere><corner><vertex><normal><texcoord><lod>", data.c_str()) {
