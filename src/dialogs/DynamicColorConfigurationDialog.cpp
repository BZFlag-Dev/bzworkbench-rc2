...
// constructor
DynamicColorConfigurationDialog::DynamicColorConfigurationDialog( dynamicColor* _theDyncol ) : ConfigurationDialog( _theDyncol, "Dynamic Color Options", DEFAULT_WIDTH, DEFAULT_HEIGHT ) {
    begin();
