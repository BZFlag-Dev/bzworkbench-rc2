...
// constructor
TextureMatrixConfigurationDialog::TextureMatrixConfigurationDialog( texturematrix* _theTexmat ) : ConfigurationDialog( _theTexmat, "Dynamic Color Options", DEFAULT_WIDTH, DEFAULT_HEIGHT ) {
    begin();
