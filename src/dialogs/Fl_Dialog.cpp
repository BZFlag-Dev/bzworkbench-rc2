...
Fl_Dialog::Fl_Dialog(const char* title) : Fl_Window(DEFAULT_WIDTH, DEFAULT_HEIGHT + DEFAULT_GROUP_HEIGHT, title) {
...
Fl_Dialog::Fl_Dialog(const char* title, unsigned long flags) : Fl_Window(DEFAULT_WIDTH, DEFAULT_HEIGHT + DEFAULT_GROUP_HEIGHT, title) {
...
Fl_Dialog::Fl_Dialog(const char* title, int width, int height, unsigned long flags) : Fl_Window(width, height + DEFAULT_GROUP_HEIGHT, title) {
